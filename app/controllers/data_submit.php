...
try {
    ...
    if ($formType === 'student') {
        ...
        $redirect = "../views/Teacher_Page.php";
    ...
    header("Location: ../views/error_page.php?status=error&msg=" . urlencode($message));
    exit;
}
?>